          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    SoftContainer(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text('Olimpio Carvalho', style: text),
                        ],
                      ),
                    ),
                    SoftContainer(
                ...
                Row(
                  children: [
                    Text("\$9.891.", style: text.copyWith(fontSize: 45)),
                    Text('00', style: subText.copyWith(fontSize: 45)),
                  ],
                ),
                Padding(
...
class Transactions extends StatelessWidget {
  ...
  const Transactions({super.key, required this.name, required this.imagePath, this.logoPayment});
